    ...
    return (
        <Box style={{marginLeft:'20px'}}>
            ...
            <SmallText>
                ...
                <Typography><StyledBadge /> Get extra ₹5000 off (price inclusive of cashback/coupon) T&C</Typography>
                <Typography><StyledBadge /> EMI starting from ₹985/monthView Plans</Typography>
